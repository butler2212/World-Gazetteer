...
$url='https://api.opencagedata.com/geocode/v1/json?q=' . $capitalCity . '&key=c479b2c3404346dcae6e1df470071c40&limit=1';
$ch = curl_init();
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, FALSE);
...
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, FALSE);
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET");
curl_setopt($ch, CURLOPT_HTTPHEADER, ["x-rapidapi-host: language-translation.p.rapidapi.com", "x-rapidapi-key: 57f3999ddamshed3b5eb66730263p1a5d3cjsn452d978dc8dd"]);
curl_setopt($ch, CURLOPT_FAILONERROR, true);
$result = curl_exec($ch);
$err = curl_error($curl);
curl_close($ch);
